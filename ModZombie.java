...
public class ModZombie extends EntityMob
{
    /**
    ...
    {
        super(par1World);
        this.texture = "/mob/modzombie.png";
        this.moveSpeed = 0.23F;
        this.getNavigator().setBreakDoors(true);
        this.tasks.addTask(0, new EntityAISwimming(this));
        this.tasks.addTask(1, new ModZombieAI(this));
    ...
    public void onKillEntity(EntityLiving par1EntityLiving)
    {
        ...
        if (this.worldObj.difficultySetting >= 2 && par1EntityLiving instanceof EntityVillager)
        {
            ...
            ModZombie modzombie = new ModZombie(this.worldObj);
            modzombie.func_82149_j(par1EntityLiving);
            this.worldObj.removeEntity(par1EntityLiving);
            modzombie.initCreature();
            modzombie.setVillager(true);

            if (par1EntityLiving.isChild())
            {
                modzombie.setChild(true);
            }

            this.worldObj.spawnEntityInWorld(modzombie);
